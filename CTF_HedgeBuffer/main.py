...
workbook = xlsxwriter.Workbook(r"C:\Users\matve\LATOKEN_PY\Sample5.xlsx")
#
# TOKENS_LIST = ['BTC', 'ETH', 'LTC', 'XRP', 'LUNA']
# BUFFER_LIST = [20 + 10*i for i in range(19)]
    ...
    for buf in range(len(BUFFER_LIST)):
        for dat in range(len(DATE_LIST)-1):
            ...
            if rows[length][l - 1] >= hedge_buffer:
                ...
                rows[length + 1][l - 5] = rows[length][l - 4]
            ...
            ws1.write(dat + 1, buf + 1, "%.4f" %(- commisions_sum))
